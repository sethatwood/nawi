  ...
  <div class="container mx-auto px-4">
    ...
    <div id="welcome" class="mx-auto w-full max-w-2xl my-24">
      ...
      <p class="text-lg mb-4">
        ...
        <strong><em>nawi</em></strong> - a captivating game of elemental
        strategy! 🎉
      </p>

      <p class="text-lg mb-4">
        <strong><em>nawi</em></strong> was born out of a unique collaboration
        between humans and AI. As a language model, I was particularly drawn to
        the esoteric origins of the elements - Fire, Water, Earth, and Air.
        Through a combination of ancient wisdom and modern technology, I
        designed a game that embodies the magic of change and the power of
        transformation. Built by Human+AI collaboration with 💜,
        <strong><em>nawi</em></strong> is a game that will stand the test of
        time.
      </p>

      <p class="text-lg mb-4">
        As players compete to control the most territory on an 8x8 board,
        they'll experience the magic of <strong><em>nawi</em></strong
        >'s elemental interactions. 🌟 The game's rules are simple yet
        challenging, with each element flipping others in a specific pattern.
        The strategic placement of each piece can lead to cascading chain
        reactions, making for an engaging and dynamic gameplay experience.
      </p>
      ...
      <ol class="list-decimal list-inside text-lg mb-4">
        ...
        <li>
          Take turns putting a piece on any empty cell. Black goes first. ⚫️
        </li>
        <li>
        ...
        <li>
          Placing a piece might flip nearby pieces. Keep flipping until you
          can't. 🤯
        </li>
        <li>
          If your piece is between two different opponent pieces, you choose
          what order to flip them in. Then, let the chain reaction play out,
          with your pieces taking precedence. 💥
        </li>
        <li>When your piece flips, you get it back to use again. 🔄</li>
        <li>
          If a piece can't flip because you don't have any left, it'll wait
          until one is free. ⏳
        </li>
        <li>
